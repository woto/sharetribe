...
module ApplicationHelper
  ...
  ICONS = {
    ...
    "font-awesome" => {
      ...
      "login" => "fa fa-signin",
      "logout" => "fa fa-signout",
      "feedback" => "fa fa-bullhorn",
      "user" => "fa fa-user",
      "deleteuser" => "fa fa-user-times",
      "settings" => " fa fa-cog",
  ...
  def icon_class(icon_name)
    ...
    if icon.nil?
      icon = (ICON_PACK == "font-awesome" ? "fa fa-circle-o" : "ss-record")
    end
    return icon
  end
  ...
  def admin_links_for(community)
    ...
    links += [
      ...
      {
        :topic => :configure,
        :text => t("admin.profile_settings.index.listing_profile_settings"),
        :icon_class => icon_class("list"),
        :path => admin_profile_settings_path,
        :name => "listing_profile_settings"
      }
    ]
